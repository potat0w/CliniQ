      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            {/* Instructions */}
            {!isRecording && !isUploading && !transcription && (
            ...
            {/* Reset Button */}
            {(transcription || error) && !isUploading && (
              <button
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <h3 className="font-semibold text-gray-800">Fast Transcription</h3>
            <p className="text-sm text-gray-600 mt-1">Instant speech-to-text conversion</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <h3 className="font-semibold text-gray-800">Word Timing</h3>
            <p className="text-sm text-gray-600 mt-1">Precise word-level timestamps</p>
          </div>
        </div>
      </div>
    </div>
